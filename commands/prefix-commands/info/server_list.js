...
module.exports = {
    name: 'serverlist',
    description: '📜 Hiển thị danh sách các máy chủ mà bot đang tham gia',
    category: 'info',
        ...
        for (const guild of client.guilds.cache.values()) {
            ...
            if (!inviteLink) {
                ...
                if (invite) {
                    ...
                    const textChannel = guild.channels.cache.find(channel => channel.type === 0); // 'GUILD_TEXT'
                    if (textChannel) {
                        const newInvite = await guild.invites.create(textChannel, { maxAge: 0 });
